...
public class Game implements Runnable
{
    ...
    private Level2State level2State;// level 2 state
    ...
    private MouseManager mouseManager;//mouse manager for the game
    ...
    private void InitGame()
    {
        ...
        //adding listeners to the canvas and making it focusable
        ...
        endState = new GameEndState(refLink);
    ...
    //sets state to playstate
    public void setPlayState(){State.SetState(playState);}
    //set state to level 2
    public void setLevel2State(){
        level2State.updateRefLinkMap();
    State.SetState(level2State);}
    //set state to end state
    public void setEndState(boolean won){
        endState.setTitle(won);
    State.SetState(endState);
    }

    //returns mouse manager
